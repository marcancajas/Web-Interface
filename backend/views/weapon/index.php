	...
	$this->widget('bootstrap.widgets.TbGridView', array(
		...
		'columns'=>array(
			...
			array(
				...
				'viewButtonUrl'=>'app()->createUrl("Weapon/View",array("id"=>$data["id"]))',
				'viewButtonIcon'=>'icon-tasks icon-large',
				'updateButtonUrl'=>'app()->createUrl("Weapon/Update",array("id"=>$data["id"]))',
				'updateButtonIcon'=>'icon-edit icon-large',
				'deleteButtonUrl'=>'app()->createUrl("Weapon/Delete",array("id"=>$data["id"]))',
