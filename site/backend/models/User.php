...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('requires_new_password, login_attempts, login_time, create_id, create_time, update_id, update_time, planID', 'numerical', 'integerOnly'=>true),
			...
			array('id, username, password, salt, password_strategy, requires_new_password, email, login_attempts, login_time, login_ip, validation_key, create_id, create_time, update_id, update_time, planID', 'safe', 'on'=>'search'),
		);
	}
