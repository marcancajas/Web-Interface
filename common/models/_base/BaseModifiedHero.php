...
/**
 * This is the model base class for the table "Modified_Hero".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ModifiedHero".
 *
 * Columns in table "Modified_Hero" available as properties of the model,
 * followed by relations of table "Modified_Hero" available as properties of the model.
 *
 * @property string $id
 ...
 */
abstract class BaseModifiedHero extends GxActiveRecord {
	public $heroId;
	...
	public static function label($n = 1) {
		return Yii::t('app', 'ModifiedHero|ModifiedHeroes', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('name, user_id, type_id, game_id, body_colour_id, hair_colour_id, strength, height, weight, speed, health, armor_health, armor_id, weapon_id, position_x, position_y', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, name, user_id, type_id, game_id, body_colour_id, hair_colour_id, strength, height, weight, speed, health, armor_health, armor_id, weapon_id, position_x, position_y', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'type_id' => Yii::t('app', 'Hero Type'),
			'game_id' => Yii::t('app', 'Game'),
			'body_colour_id' => Yii::t('app', 'Body Colour'),
			'hair_colour_id' => Yii::t('app', 'Hair Colour'),
