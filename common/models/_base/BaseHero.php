...
/**
 * This is the model base class for the table "Hero".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Hero".
 *
 * Columns in table "Hero" available as properties of the model,
 * followed by relations of table "Hero" available as properties of the model.
 *
 * @property string $id
 ...
 */
abstract class BaseHero extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Hero|Heroes', $n);
	}
	...
	public function attributeLabels() {
		return array(
			...
			'position_x' => Yii::t('app', 'Initial Position X'),
			'position_y' => Yii::t('app', 'Initial Position Y'),
		);
	}
